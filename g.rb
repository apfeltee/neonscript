...
src=<<__eos__
    ...
    NEON_OP_INSTANCEINVOKEMETHOD,
    NEON_OP_INSTANCEINVOKESELF,
    NEON_OP_SUPER_INVOKE,
    NEON_OP_CLASS_PROPERTY,
    NEON_OP_CLOSURE,
    NEON_OP_UPVALCLOSE,
    NEON_OP_RETURN,
    NEON_OP_CLASS,
    ...
    NEON_OP_GET_SELF_PROPERTY,
    NEON_OP_BREAK_PL,
__eos__


src.split(",").map(&:strip).reject(&:empty?).each{|s|
