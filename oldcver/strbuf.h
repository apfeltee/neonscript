...
StringBuffer* dyn_strbuf_makefromstring(const char* str, size_t len);
...
bool dyn_strbuf_appendstrn(StringBuffer* buf, const char* str, size_t len);
bool dyn_strbuf_appendstr(StringBuffer* buf, const char* str);
