...
#define NNALLOC_CONST_MAXSIZET (~(size_t)0)
#define NNALLOC_CONST_MALLOCALIGNMENT ((size_t)8U)

#define NNALLOC_CONST_DEFAULTGRANULARITY ((size_t)128U * (size_t)1024U)
#define NNALLOC_CONST_DEFAULTTRIMTHRESHOLD ((size_t)2U * (size_t)1024U * (size_t)1024U)
#define NNALLOC_CONST_DEFAULTMMAPTHRESHOLD ((size_t)128U * (size_t)1024U)
