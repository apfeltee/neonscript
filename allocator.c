...
/* Select native OS if no target OS defined. */
    ...
    #define NNALLOC_TARGET_WINDOWS
#elif defined(__linux__)
    #define NNALLOC_TARGET_LINUX
#elif defined(__MACH__) && defined(__APPLE__)
    #define NNALLOC_TARGET_OSX
#elif(defined(__sun__) && defined(__svr4__)) || defined(__CYGWIN__)
    #define NNALLOC_TARGET_POSIX
#else
    #define NNALLOC_TARGET_OTHER
#endif
...
/* Set target architecture properties. */
    ...
    #define NNALLOC_ARCH_IS32BIT
#elif defined(__x86_64__) || defined(__x86_64) || defined(_M_X64) || defined(_M_AMD64)
    #define NNALLOC_ARCH_IS64BIT
...
#define IS_DIRECT_BIT (NNALLOC_CONST_SIZETONE)
...
#if defined(NNALLOC_TARGET_WINDOWS)
    #if defined(NNALLOC_ARCH_IS64BIT)
    ...
    /* 64 bit mode needs special support for allocating memory in the lower 2GB. */
        ...
        #elif defined(NNALLOC_TARGET_OSX) || defined(NNALLOC_TARGET_PS4) || defined(__FreeBSD__) || defined(__FreeBSD_kernel__) || defined(__NetBSD__) || defined(__OpenBSD__) || defined(__sun__)
            ...
            */
            #if defined(NNALLOC_TARGET_OSX)
                #define MMAP_REGION_START ((uintptr_t)0x10000)
            #elif defined(NNALLOC_TARGET_PS4)
            ...
            #if(defined(__FreeBSD__) || defined(__FreeBSD_kernel__)) && !defined(NNALLOC_TARGET_PS4)
    ...
    #if defined(NNALLOC_TARGET_LINUX)
